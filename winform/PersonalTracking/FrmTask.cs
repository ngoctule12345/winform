    ...
    public partial class FrmTask : Form
    {
        ...
        private void FrmTask_Load(object sender, EventArgs e)
        {
            ...
            if(isUpdate)
            {
                ...
                cmbTaskSate.DisplayMember = "StateName";
                cmbTaskSate.ValueMember = "ID";
                cmbTaskSate.SelectedValue=detail.taskStateID;
            }
        }
            ...
            else
            {
                ...
                else if (isUpdate)
                {
                    ...
                    if(result == DialogResult.Yes)
                    {
                        ...
                        if(Convert.ToInt32(textUserNo.Text) != detail.UserNo)
                        ...
                        update.TaskState = Convert.ToInt32(cmbTaskSate.SelectedValue);
